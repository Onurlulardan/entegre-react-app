...
import flagEs from '../assets/images/flags/spain.svg';
import flagChina from '../assets/images/flags/china.svg';
import flagFr from '../assets/images/flags/french.svg';
import flagGr from '../assets/images/flags/germany.svg';
import flagIt from '../assets/images/flags/italy.svg';
import flagRu from '../assets/images/flags/russia.svg';


function NavBar () {
    const appnav = document.querySelector("#appnav");
    console.log("navbar bağlandı");
    ...
    return (
        <section>
                ...
                <div className="navbar-header">
                    <div className="d-flex">
                        ...
                        <span className="logo-sm">
                                <img src={require('../assets/images/logo-dark.png')} alt="" height="22"/>
                            </span>
                            <span className="logo-lg">
                                <img src={require('../assets/images/logo-dark.png')} alt="" height="17"/>
                            </span>
                        </Link>

                        <Link to="/" className="logo logo-light">
                        <span className="logo-sm">
                                <img src={require('../assets/images/logo-sm.png')} alt="" height="22"/>
                            </span>
                            <span className="logo-lg">
                                <img src={require('../assets/images/logo-light.png')} alt="" height="17"/>
                            </span>
                        </Link>
                        </div>

                        <button onClick={onClickBtn} type="button" className="btn btn-sm px-3 fs-16 header-item vertical-menu-btn topnav-hamburger hamburger-btn"
                        ...
                        <form className="app-search d-none d-md-block">
                            <div className="position-relative">
                                <input type="text" className="form-control" placeholder="Search..." autoComplete="off"
                                    id="search-options" defaultValue=""/>
                            ...
                            <div className="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                                <div data-simplebar  style={{maxHeight: '320px'}}>
                                    ...
                                    <div className="dropdown-item bg-transparent text-wrap">
                                        <a href="index.html" className="btn btn-soft-secondary btn-sm btn-rounded">how to setup <i
                                                className="mdi mdi-magnify ms-1"></i></a>
                                        <a href="index.html" className="btn btn-soft-secondary btn-sm btn-rounded">buttons <i
                                                className="mdi mdi-magnify ms-1"></i></a>
                                    </div>
                                    ...
                                    <div className="notification-list">
                                        <a href="#" onClick={e => e.preventDefault()} className="dropdown-item notify-item py-2">
                                            <div className="d-flex">
                                                    <img src={require('../assets/images/users/avatar-2.jpg')}
                                        ...
                                        <a href="#" onClick={e => e.preventDefault()} className="dropdown-item notify-item py-2">
                                            <div className="d-flex">
                                                    <img src={require('../assets/images/users/avatar-3.jpg')}
                                                    className="me-3 rounded-circle avatar-xs" alt="user-pic"/>
                                                <div className="flex-1">
                                        ...
                                        <a href="#" onClick={e => e.preventDefault()} className="dropdown-item notify-item py-2">
                                            <div className="d-flex">
                                                    <img src={require('../assets/images/users/avatar-5.jpg')}
                                                    className="me-3 rounded-circle avatar-xs" alt="user-pic"/>
                                                <div className="flex-1">
                                ...
                                <div className="text-center pt-3 pb-1">
                                    <a href="pages-search-results.html" className="btn btn-primary btn-sm">View All Results <i
                                            className="ri-arrow-right-line ms-1"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown ms-1 topbar-head-dropdown header-item">
                            <button type="button" className="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img id="header-lang-img" src={flagUs} alt="Header Language" height="20"
                                    className="rounded"/>
                                        
                            </button>
                            <div className="dropdown-menu dropdown-menu-end">

                                <a href="#" onClick={e => e.preventDefault()} className="dropdown-item notify-item language py-2" data-lang="en"
                                    title="English">
                                    <img src={flagUs} alt="user-image" className="me-2 rounded" height="18"/>

                                    <span className="align-middle">English</span>
                                </a>

                                <a href="#" onClick={e => e.preventDefault()} className="dropdown-item notify-item language" data-lang="sp"
                                    title="Spanish">
                                    <img src={flagEs} alt="user-image" className="me-2 rounded" height="18"/>
                                    <span className="align-middle">Española</span>
                                </a>

                                <a href="#" onClick={e => e.preventDefault()} className="dropdown-item notify-item language" data-lang="gr"
                                    title="German">
                                    <img src={flagGr} alt="user-image" className="me-2 rounded"
                                        height="18"/> <span className="align-middle">Deutsche</span>
                                </a>

                                <a href="#" onClick={e => e.preventDefault()} className="dropdown-item notify-item language" data-lang="it"
                                    title="Italian">
                                    <img src={flagIt} alt="user-image" className="me-2 rounded" height="18"/>
                                    <span className="align-middle">Italiana</span>
                                </a>

                                <a href="#" onClick={e => e.preventDefault()} className="dropdown-item notify-item language" data-lang="ru"
                                    title="Russian">
                                    <img src={flagRu} alt="user-image" className="me-2 rounded" height="18"/>
                                    <span className="align-middle">русский</span>
                                </a>

                                <a href="#" onClick={e => e.preventDefault()} className="dropdown-item notify-item language" data-lang="ch"
                                    title="Chinese">
                                    <img src={flagChina} alt="user-image" className="me-2 rounded" height="18"/>
                                    <span className="align-middle">中国人</span>
                                </a>

                                <a href="#" onClick={e => e.preventDefault()} className="dropdown-item notify-item language" data-lang="fr"
                                    title="French">
                                    <img src={flagFr} alt="user-image" className="me-2 rounded" height="18"/>
                            ...
                            <div className="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                                ...
                                <div className="p-2">
                                    ...
                                    <div className="row g-0">
                                        ...
                                        <div className="col">
                                            <a className="dropdown-icon-item" href="#!">
                                                <img src={require('../assets/images/brands/mail_chimp.png')} alt="mail_chimp"/>
                        ...
                        <div className="dropdown topbar-head-dropdown ms-1 header-item">
                            <button type="button" className="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                                ...
                                <span
                                    className="position-absolute topbar-badge cartitem-badge fs-10 translate-middle badge rounded-pill bg-info">5</span>
                            </button>
                                ...
                                <div data-simplebar style={{maxHeight: '300px'}}>
                                    <div className="p-2">
                                        <div className="text-center empty-cart" id="empty-cart">
                                            ...
                                            <a href="#" className="btn btn-success w-md mb-3">Shop Now</a>
                                        </div>
                                        <div className="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="ps-2">
                                                    <button type="button"
                                                        className="btn btn-icon btn-sm btn-ghost-secondary remove-item-btn"><i
                                                ...
                                                <div className="flex-1">
                                                    <h6 className="mt-0 mb-1 fs-14">
                                                        <a href="apps-ecommerce-product-details.html"
                                                            className="text-reset">Bentwood Chair</a>
                                                    </h6>
                                                    <p className="mb-0 fs-12 text-muted">
                                        ...
                                        <div className="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="flex-1">
                                                    <h6 className="mt-0 mb-1 fs-14">
                                                        <a href="apps-ecommerce-product-details.html"
                                                            className="text-reset">Stillbird Helmet</a>
                                                    </h6>
                                                    <p className="mb-0 fs-12 text-muted">
                                            ...
                                            <div
                                                ...
                                                <div className="d-flex">
                                                    ...
                                                    <div className="px-2 fs-15">
                                                        <div className="form-check notification-check">
                                                            <input className="form-check-input" type="checkbox" defaultValue=""
                                                                id="all-notification-check02" defaultChecked/>
                                                            <label className="form-check-label"
            ...
            <div id="appnav" className="app-menu navbar-menu actives" >
                <div className="navbar-brand-box new-navbar">
                    <router-link to="/" className="logo logo-dark">
                    <span className="logo-sm">
                            {/* <img src={require('../assets/images/logo-sm.png')} alt="" height="22" /> */}
                        </span>
                        <span className="logo-lg">
                    ...
                    <router-link to="/" className="logo logo-light">
                    <span className="logo-sm">
                            {/* <img src={require('../assets/images/logo-sm.png')} alt="" height="22" /> */}
                        </span>
                        <span className="logo-lg">
                ...
                <div id="scrollbar" >
                    ...
                    <div className="container-fluid">
                        <button onClick={onClickBtn} type="button" className="btn btn-sm px-3 fs-16 header-item vertical-menu-btn topnav-hamburger hamburger-btn close-btnn"
                            id="topnav-hamburger-icon1">
                            <span className="hamburger-icon">
                        ...
                        <ul className="navbar-nav" id="navbar-nav">
                            ...
                            <li className="nav-item">
                                <Link to="/" className="nav-link menu-link" >
                                    <i className="ri-dashboard-2-line"></i> <span data-key="t-dashboards" id="hmbrmenu" >Dashboards</span>
                                </Link>
                                 {/* <div className="collapse menu-dropdown" id="sidebarDashboards">
                                    <ul className="nav nav-sm flex-column">
                                        <li className="nav-item">
                                            <a href="dashboard-analytics.html" className="nav-link" data-key="t-analytics"> Analytics
                                            </a>
                                        </li>
                                        <li className="nav-item">
                            ...
                            <li className="menu-title"><i className="ri-more-fill"></i> <span data-key="t-pages" id="hmbrmenu" >İşlemler</span></li>

                            <li className="nav-item">
                                <a className="nav-link menu-link" href="#sidebarForms" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarForms">
                                    <i className="ri-file-list-3-line"></i> <span data-key="t-forms" id="hmbrmenu"  >Siparişler</span>
                                </a>
                             ...
                             {/* <li className="nav-item">
                                <a className="nav-link menu-link" href="#sidebarPages" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarPages">
                                    <i className="ri-pages-line"></i> <span data-key="t-pages">Faturalar</span>
                                </a>
                                <div className="collapse menu-dropdown" id="sidebarPages">
                                    <ul className="nav nav-sm flex-column">
                                        ...
                                        <li className="nav-item">
                                            <a href="#sidebarProfile" className="nav-link" data-bs-toggle="collapse" role="button"
                                        ...
                                        <li className="nav-item">
                                            <a href="pages-search-results.html" className="nav-link" data-key="t-search-results"> Search
                                                Results </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li className="nav-item">
                                <a className="nav-link menu-link" href="#sidebarAdvanceUI" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarAdvanceUI">
                                    <i className="ri-stack-line"></i> <span data-key="t-advance-ui" id="hmbrmenu" >Ürünler</span>
                            
                                </a>
                                <div className="collapse menu-dropdown" id="sidebarAdvanceUI">
                                    <ul className="nav nav-sm flex-column">
                                        <li className="nav-item">
                                        <Link to="/ProductList" className="nav-link">Ürün Listesi</Link>
                                        </li>
                                        <li className="nav-item">
                                        <Link className="nav-link" to="/CategoryPage">Kategori Listesi</Link>
                                        </li>
                                        <li className="nav-item">
                                        <Link className="nav-link" to="/BrandList">Marka Listesi</Link>
                                        </li>
                                        <li className="nav-item">
                                        <Link className="nav-link" to="/newproduct">Ürün Ekle</Link>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link menu-link" href="#sidebarmembers" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarmembers">
                                    <i className="ri-user-star-line"></i> <span data-key="t-advance-ui" id="hmbrmenu" >Müşteriler</span>
                            
                                </a>
                                <div className="collapse menu-dropdown" id="sidebarmembers">
                                    <ul className="nav nav-sm flex-column">
                                        
                                        <li className="nav-item">
                                        <Link className="nav-link" to="/MemberList">Müşteri Listesi</Link>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                             {/* <li className="nav-item">
                                <a className="nav-link menu-link" href="#sidebarCharts" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarCharts">
                                    <i className="ri-pie-chart-line"></i> <span data-key="t-charts">Raporlar</span>
                                </a>
                                <div className="collapse menu-dropdown" id="sidebarCharts">
                                    <ul className="nav nav-sm flex-column">
                                        <li className="nav-item">
                                            <a href="#sidebarApexcharts" className="nav-link" data-bs-toggle="collapse" role="button"
                                            ...
                                            <div className="collapse menu-dropdown" id="sidebarApexcharts">
                                                <ul className="nav nav-sm flex-column">
                                                    ...
                                                    <li className="nav-item">
                                                        <a href="charts-apex-candlestick.html" className="nav-link"
                                                    ...
                                                    <li className="nav-item">
                                                        <a href="charts-apex-radialbar.html" className="nav-link"
                            ...
                            <li className="nav-item">
                                <a className="nav-link menu-link" href="#sidebarIcons" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarIcons">
                                    <i className="ri-compasses-2-line"></i> <span data-key="t-icons" id="hmbrmenu" >Ayarlar</span>
                                </a>
                                <div className="collapse menu-dropdown" id="sidebarIcons">
                                    <ul className="nav nav-sm flex-column">
                                        <li className="nav-item">
                                            <Link className="nav-link"  to="/StoreSettings">Mağaza Ayarları</Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link className="nav-link"  to="/AccountSettings">Hesap Ayarları</Link>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                             ...
                             {/* <li className="nav-item">
                                <a className="nav-link menu-link" href="widgets.html">
                                    <i className="ri-honour-line"></i> <span data-key="t-widgets">Destek</span>
                                </a>
                            </li>  */}
